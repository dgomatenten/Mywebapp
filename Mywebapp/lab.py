...
@bp.route('/lab/register', methods=['GET', 'POST'])
def register():
...
@bp.route('/lab/index',methods=['GET', 'POST'])
def index():
    data = EngContent.query.all()
    #conver Json 
    return render_template('/lab/contindex.html', contents=data)

@bp.route('/lab/<int:id>/contupdate',methods=['GET', 'POST'])
def contupdate(id):
    ...
    return render_template('/lab/contupdate.html',content=contents,id=key,title=contents.Title)

@bp.route('/lab/<int:id>/wordcount',methods=['GET', 'POST'])
def wordcount(id):
    ...
    # load data to DB 
    #return redirect(url_for('lab.index'))
    return render_template('/lab/test.html',content=engconts)
